...
-- Patient billing must charge one service row per bill/date/service.
-- Staff payout remains staff-wise, so multi-partner duties still create
-- separate payout rows without double-charging the patient.
